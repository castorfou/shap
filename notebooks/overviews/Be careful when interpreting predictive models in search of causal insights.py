...
for col in list(X.columns):
    shap.plots.scatter(shap_values[:, col], title="SHAP value\n(higher means more likely to renew)")
...
shap.plots.scatter(shap_values, title="SHAP value\n(higher means more likely to renew)", overlay={
...
# <hr>
# Have a comment or question? Checkout github or the Medium version of this article!
